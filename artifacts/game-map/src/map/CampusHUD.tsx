  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ borderTop: "1px solid #e8ecf0", margin: "9px 0 9px" }} />
...
function StatPill({ value, label, color, emoji }: {
  value: number; label: string; color: string; emoji: string;
}) {
  return (
    <div style={{
      background: "#f8fafc",
