...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      <button
        onClick={handleOpen}
        className="p-2 rounded-xl hover:bg-secondary transition-colors relative focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-ring"
        aria-label={
          unreadCount > 0
                ...
                <div className="flex items-center gap-1">
                  {unreadCount > 0 && (
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-secondary transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-ring"
                      title="Mark all read"
