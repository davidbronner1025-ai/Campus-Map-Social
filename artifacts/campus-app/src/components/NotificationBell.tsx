              ...
              <div className="flex-1 overflow-y-auto">
                ...
                {notifs.map((n) => (
                  <button
                    key={n.id}
                    onClick={() => handleTap(n)}
                    className={`w-full flex items-start gap-3 px-4 py-3 text-left transition-colors hover:bg-secondary/50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:-outline-offset-1 ${!n.read ? "bg-primary/5" : ""}`}
                  >
