...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      <button onClick={handleOpen} aria-label="Open notifications" className="p-2 rounded-xl hover:bg-secondary transition-colors relative">
            ...
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-border">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button onClick={() => setOpen(false)} aria-label="Close notifications" className="p-1.5 rounded-lg hover:bg-secondary transition-colors">
