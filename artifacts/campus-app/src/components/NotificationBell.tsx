...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      <button onClick={handleOpen} className="p-2 rounded-xl hover:bg-secondary transition-colors relative" aria-label="Notifications">
                ...
                <div className="flex items-center gap-1">
                  {unreadCount > 0 && (
                    <button onClick={handleMarkAllRead}
                      className="p-1.5 rounded-lg hover:bg-secondary transition-colors" title="Mark all read" aria-label="Mark all as read">
                      <CheckCheck className="w-3.5 h-3.5 text-muted-foreground" />
                    </button>
                  )}
                  <button onClick={() => setOpen(false)} className="p-1.5 rounded-lg hover:bg-secondary transition-colors" aria-label="Close notifications">
