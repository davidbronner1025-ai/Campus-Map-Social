  ...
  return (
    <div className="relative">
      <button
        ...
        className="p-2 rounded-xl hover:bg-secondary transition-colors relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      >
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                {notifs.map((n) => (
                  <button
                    key={n.id}
                    onClick={() => handleTap(n)}
                    className={`w-full flex items-start gap-3 px-4 py-3 text-left transition-colors hover:bg-secondary/50 focus-visible:outline-none focus-visible:bg-secondary/80 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring ${!n.read ? "bg-primary/5" : ""}`}
                  >
